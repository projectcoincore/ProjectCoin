...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/projectcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/projectcoin-cli.cpp \
           src/projectcoin-tx.cpp \
           src/projectcoin.cpp \
           src/db.cpp \
           ...
           src/qt/projectcoin.cpp \
           src/qt/projectcoinstrings.cpp \
...
RESOURCES += src/qt/projectcoin.qrc src/qt/projectcoin_locale.qrc

TRANSLATIONS += src/qt/locale/projectcoin_bg.ts \
                src/qt/locale/projectcoin_de.ts \
                src/qt/locale/projectcoin_en.ts \
                src/qt/locale/projectcoin_es.ts \
                src/qt/locale/projectcoin_fi.ts \
                src/qt/locale/projectcoin_fr.ts \
                src/qt/locale/projectcoin_it.ts \
                src/qt/locale/projectcoin_ja.ts \
                src/qt/locale/projectcoin_pl.ts \
                src/qt/locale/projectcoin_pt.ts \
                src/qt/locale/projectcoin_ru.ts \
                src/qt/locale/projectcoin_sk.ts \
                src/qt/locale/projectcoin_sv.ts \
                src/qt/locale/projectcoin_vi.ts \
                src/qt/locale/projectcoin_zh_CN.ts \
                src/qt/locale/projectcoin_zh_TW.ts
