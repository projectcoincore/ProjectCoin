...
#   c) node1 mines 32 blocks, so now node 0 has 60001projectcoin, node 1 has 4250projectcoin, node2 has none.
#   d) node0 sends 601 projectcoin to node2, in two transactions (301 projectcoin, then 300 projectcoin).
