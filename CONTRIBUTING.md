Contributing to ProjectCoin Core
============================

The ProjectCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ProjectCoin Core project, and is not to be
confused with overall ProjectCoin Network Protocol consensus changes.

Whether a pull request is merged into ProjectCoin Core rests with the project merge
...
Patches that change ProjectCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ProjectCoin consensus, it must have been
...
The project leader is the release manager for each ProjectCoin Core release.
