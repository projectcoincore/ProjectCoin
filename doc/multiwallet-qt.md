...
In order to support loading of multiple wallets in projectcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is projectcoin.cpp.
...
Changes to projectcoin.cpp
----------------------
projectcoin.cpp is the entry point into projectcoin-qt, and as such, will require some minor modifications to provide hooks for
