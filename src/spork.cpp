...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_8_PATCH_ENFORCEMENT) r = SPORK_8_PATCH_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_8_PATCH_ENFORCEMENT") return SPORK_8_PATCH_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_8_PATCH_ENFORCEMENT) return "SPORK_8_PATCH_ENFORCEMENT";
