...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ProjectCoin Core"),
     ...
     * override -datadir in the projectcoin.conf file in the default data directory
     * (to be consistent with projectcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
