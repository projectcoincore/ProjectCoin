...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ProjectCoin Core projectcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  projectcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ProjectCoin transaction") + "\n" +
                               "  projectcoin-tx [options] -create [commands]   " + _("Create hex-encoded ProjectCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ProjectCoin transaction
