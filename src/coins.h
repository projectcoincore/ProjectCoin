...
/**
    ...
    ****Note - for ProjectCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /**
     * Amount of ProjectCoin coming in to a transaction
